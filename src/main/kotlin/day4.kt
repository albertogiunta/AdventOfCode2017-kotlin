fun main(args: Array<String>) {
    ...
    val passPhrases  = listOf("pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk",
    ...
    println("Total valid passphrases: " + passPhrases.filter { el -> isValidWithRule1(el) }.count())
    ...
    println("Total valid passphrases: " + passPhrases.filter { el -> isValidWithRule2(el) }.count())

}

fun isValidWithRule1(phrase: String): Boolean = phrase.split(" ").sorted().distinct().count() == phrase.split(" ").size

fun isValidWithRule2(phrase: String): Boolean = phrase.split(" ").map { it -> it.toCharArray().sorted().toString() }.sorted().distinct().count() == phrase.split(" ").size